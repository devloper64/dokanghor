            ...
            <Table responsive>
              <thead>
                <tr>
                  ...
                  <th className="hand" onClick={sort('size_mesaurments')}>
                    Size Mesaurments <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={sort('size_details')}>
              ...
              <tbody>
                {productDetailsList.map((productDetails, i) => (
                  <tr key={`entity-${i}`}>
                    ...
                    <td>{productDetails.size_mesaurments}</td>
                    <td>{productDetails.size_details}</td>
