  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="ecommerceApp.mobileIntro.home.createOrEditLabel">Create or edit a MobileIntro</h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
            ...
            <AvForm model={isNew ? {} : mobileIntroEntity} onSubmit={saveEntity}>
              {!isNew ? (
                <AvGroup>
                  ...
                  <AvInput id="mobile-intro-id" type="text" className="form-control" name="id" required readOnly />
                </AvGroup>
              ) : null}
              <AvGroup>
