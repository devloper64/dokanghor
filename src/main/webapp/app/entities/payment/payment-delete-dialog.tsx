...
export const PaymentDeleteDialog = (props: IPaymentDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="ecommerceApp.payment.delete.question">Are you sure you want to delete this Payment?</ModalBody>
      <ModalFooter>
        <Button color="secondary" onClick={handleClose}>
          <FontAwesomeIcon icon="ban" />
          &nbsp; Cancel
        </Button>
        <Button id="jhi-confirm-delete-payment" color="danger" onClick={confirmDelete}>
